...
```sh
swift build
./scripts/package-release.sh 1.3.1
```
...
```text
dist/Paste vlv.app
dist/Paste-vlv-1.3.1-macos-unsigned.zip
dist/Paste-vlv-1.3.1-macos-unsigned.zip.sha256
```
...
gh release create v1.3.1 \
  dist/Paste-vlv-1.3.1-macos-unsigned.zip \
  dist/Paste-vlv-1.3.1-macos-unsigned.zip.sha256 \
  --title "Paste vlv v1.3.1" \
  --notes-file .github/release-notes/v1.3.1.md
```
...
4. Select tag `v1.3.1`.
5. Set title `Paste vlv v1.3.1`.
6. Paste `.github/release-notes/v1.3.1.md`.
7. Upload:
   - `dist/Paste-vlv-1.3.1-macos-unsigned.zip`
   - `dist/Paste-vlv-1.3.1-macos-unsigned.zip.sha256`
8. Publish.
